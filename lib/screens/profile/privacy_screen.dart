      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.shield, color: Color(0xFFB08D57), size: 30),
                SizedBox(width: 15),
                Text('Privacy Policy', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              ],
            ),
            SizedBox(height: 20),
            Text('1. Information Collection', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('2. Use of Information', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('3. Data Security', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
