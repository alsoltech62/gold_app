      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.description, color: Color(0xFFB08D57), size: 30),
                SizedBox(width: 15),
                Text('Terms & Conditions', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              ],
            ),
            SizedBox(height: 20),
            Text('1. Agreement to Terms', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('2. Digital Gold and Silver', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('3. Wallet and SIP', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
