      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.assignment_return, color: Color(0xFFB08D57), size: 30),
                SizedBox(width: 15),
                Text('Returns Policy', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              ],
            ),
            SizedBox(height: 20),
            Text('1. Physical Delivery Returns', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('2. Digital Assets', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
            ...
            SizedBox(height: 20),
            Text('3. Claim Process', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFB08D57))),
            SizedBox(height: 5),
            Text(
