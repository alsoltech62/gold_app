...
class _BuyGoldScreenState extends State<BuyGoldScreen> {
  ...
  void _calculateGrams(String value) {
    ...
    final rateRaw = Provider.of<GoldProvider>(
      context,
      listen: false,
    ).currentRate?['rate_per_gram'];
    final rate = rateRaw != null
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Color(0xFFB08D57)),
                ),
              ),
            ),
          ],
  ...
  void _showPaymentVerificationDialog(double amount, String orderId) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'Did you complete the payment in the browser? Click below to verify and add gold to your vault.',
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              final result = await Provider.of<GoldProvider>(
                context,
                listen: false,
              ).buyGold(amount, 'RRFINCO', orderId);
              if (!mounted) return;
              setState(() => _isProcessingPayment = false);
              ...
              child: Consumer<GoldProvider>(
                builder: (context, gold, child) {
                  return ElevatedButton(
                    onPressed: (gold.isLoading || _isProcessingPayment)
                        ? null
                        : _handleBuy,
